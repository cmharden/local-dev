...
# Add the ironbank creds
echo "NOTE: "
echo "Add your ironbank creds"
## set +o history
## export REGISTRY1_USERNAME=<real values>
## export REGISTRY1_PASSWORD=<real values>
## echo $REGISTRY1_PASSWORD | zarf tools registry login registry1.dso.mil --username $REGISTRY1_USERNAME --password-stdin
## set -o history

# Zarf init the new cluster
